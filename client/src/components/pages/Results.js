        ...
        {displayInfo ? (
          <div className="info">
            <p>
              ...
              {displayInfo?.data?.extractedData?.amount}
            </p>
            <p>
              <span className="info-subhead"> Amount in Words:</span>&ensp;{" "}
              {displayInfo?.data?.extractedData?.wordsAmount}
            </p>
            <p>
              <span className="info-subhead"> Date:</span>&ensp;{" "}
              {displayInfo?.data?.extractedData?.date}
            </p>
            <p>
              <span className="info-subhead"> Validation:</span>&ensp;
              {displayInfo?.data?.extractedData?.valid?.validation
                ? "Valid"
                : "Invalid"}
            </p>
            <p>
          ...
          <div className="info-placeholder">
            <h3>
              Your information will show up here after clicking validating
            </h3>
          </div>
        )}
      </div>
